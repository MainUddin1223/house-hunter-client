  ...
  return (
    <div className="bg-primary p-2">
      <div className=" container mx-auto text-white flex justify-between font-semibold">
        <div className=" md:text-2xl text-lg cursor-pointer" onClick={()=>navigate('/')}>
          <h1>HOUSE RENTER</h1>
        </div>
        <div>
            {
               userData?.email ?
          <button className="bg-button-color px-4 py-1 rounded" onClick={handleNavigate}>Dashboard</button>
