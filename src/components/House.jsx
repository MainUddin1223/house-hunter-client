...
const House=({houseData})=>{
    ...
    return(
   <>
        <div className="cursor-pointer" onClick={()=>{navigate(`/house/details/${houseData._id}`)}}>
        <div className="flex items-center justify-center">
            <div className="max-w-sm w-full sm:w-full lg:w-full py-6 px-3">
                <div className="bg-white shadow-xl rounded-lg overflow-hidden">
                    <div className="bg-cover bg-center h-56 p-4" style={{backgroundImage: `url(${houseData.picture})`}}>
                    ...
                    <div className="p-4">
                        <p className="uppercase tracking-wide text-sm font-bold text-gray-700">{houseData.name}</p>
                        <p className="text-3xl text-gray-900">${houseData.rent}</p>
                        <p className="text-gray-700">{houseData.address}</p>
                        <p className="text-gray-700">{houseData.city}</p>
                    </div>
                    <div className="flex p-4 border-t border-gray-300 text-gray-700">
                        <div className="flex-1 inline-flex items-center">
                            ...
                            <p><span className="text-gray-900 font-bold">{houseData.bedrooms}</span></p>
                        </div>
                        <div className="flex-1 inline-flex items-center">
                            <svg className="h-6 w-6 text-gray-600 fill-current mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <p><span className="text-gray-900 font-bold">{houseData.bathrooms}</span> </p>
                        </div>
                    </div>
                </div>
            </div>
